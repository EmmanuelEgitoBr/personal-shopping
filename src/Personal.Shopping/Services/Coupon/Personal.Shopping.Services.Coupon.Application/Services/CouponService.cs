...
public class CouponService : ICouponService
{
    ...
    public async Task<ResponseDto<IEnumerable<CouponDto>>> GetAllCuponsAsync()
    {
    ...
    public async Task<ResponseDto<CouponDto>> GetCuponByIdAsync(int couponId)
    {
    ...
    public async Task<ResponseDto<CouponDto>> GetCuponByCodeAsync(string couponCode)
    {
